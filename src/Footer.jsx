  ...
  return (
    <footer className="footer-container">
      <section className="foot-box1">
        ...
        <p>
          <span className="span">Rayora </span>is a trusted real estate platform
          specializing in verified land and residential plots. We ensure
          transparent, secure, and smooth property transactions.
        </p>
      </section>
